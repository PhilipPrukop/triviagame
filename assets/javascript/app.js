    ...
    // this game object holds all of the questions, possible answers, and then the index of the correct answer for each
        var game = {
            questions: [
            {
                ...
                possibles: ['Bennie and the Jets', 'Across the Universe', 'I Saw Her Standing There', 'Imagine'],
                id: 'question-one',
                answer: 2
            }, {
                question: 'Which Beatle crossed Abbey Road first',
                possibles: ['George', 'Ringo', 'John', 'Paul', 'Evanston'],
                id: 'question-two',
                answer: 2
            }, {
                question: 'Who was the first Beatle to get married?',
                possibles: ['Ringo', 'Paul', 'George', 'John'],
                id: 'question-three',
                answer: 3
            }, {
                question: 'Who was the original drummer for the Beatles?',
                possibles: ['Pete Best', 'Stuart Sutecliffe', 'Billy Wyan', 'Ringo Star', 'Paul McCartney'],
                id: 'question-four',
                answer: 0
            }, 
            ]}
